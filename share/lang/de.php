...
define('OVERVIEW_HEADING_CUSTOMVARIABLES', 'Ma&szlig;geschneiderten Variablen');
...
define('OVERVIEW_HEADING_NOTIFY_ON', 'Benachr. Filter');
...
define('OVERVIEW_ACTIVE_TOOLTIP_CONFIRM', 'Benachrichtigung deaktivieren?');
define('OVERVIEW_INACTIVE_TOOLTIP_CONFIRM', 'Benachrichtigung aktivieren?');
...
define('ADD_EDIT_INCLUDE_CUSTOMVARIABLES', 'Ma&szlig;geschneiderten Variablen einschlie&szlig;en:');
define('ADD_EDIT_EXCLUDE_CUSTOMVARIABLES', 'Ma&szlig;geschneiderten Variablen ausschlie&szlig;en:');
...
define('ADD_EDIT_NOTIFY_BY', 'Nachricht per:');
define('ADD_EDIT_NOTIFY_ON', 'Nachricht Filter:');
...
define('ADD_EDIT_NUM_NOTIFICATIONS', 'Anzahl (alle Arten)');
...
define('LOG_VIEWER_HEADING_CUSTOMVARIABLE', 'Ma&szlig;geschneiderten Variablen');
...
define('NOTIFY_RECOVERY', 'Erholung');
define('NOTIFY_SPECIAL', 'Andere');
define('NOTIFY_OK', 'Service OK');
define('NOTIFY_WARNING', 'Warnung');
define('NOTIFY_CRITICAL', 'Kritischer Zustand');
define('NOTIFY_UNKNOWN', 'Unbekannt');
define('NOTIFY_UP', 'Host an');
define('NOTIFY_UNREACHABLE', 'Host nicht erreichbar');
define('NOTIFY_DOWN', 'Host aus');
define('NOTIFY_FLAPPING_START', 'Flapping angefangen');
define('NOTIFY_FLAPPING_STOP', 'Flapping beendet');
define('NOTIFY_FLAPPING_DISABLED', 'Flapping-Erkennung ausgeschaltet');
define('NOTIFY_DOWNTIME_START', 'Gepl. Ausfallzeit angefangen');
define('NOTIFY_DOWNTIME_END', 'Gepl. Ausfallzeit beendet');
define('NOTIFY_DOWNTIME_CANCELLED', 'Gepl. Ausfallzeit abgebrochen');
...
define('NOTIFY_CRITICAL_TO_UNKNOWN', 'Kritisch auf Unbekannt');
define('NOTIFY_UNKNOWN_TO_CRITICAL', 'Unbekannt auf kritisch');
define('NOTIFY_UNKNOWN_TO_WARNING', 'Unbekannt auf Warnung');
