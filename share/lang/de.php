...
define('NOTIFY_FLAPPING_START', 'Flattern angefangen');
define('NOTIFY_FLAPPING_STOP', 'Flattern beendet');
define('NOTIFY_FLAPPING_DISABLED', 'Flatter-Erkennung ausgeschaltet');
define('NOTIFY_DOWNTIME_START', 'Geplante Ausfallzeit angefangen');
define('NOTIFY_DOWNTIME_END', 'Geplante Ausfallzeit beendet');
