...
define('OVERVIEW_ACTIVE_TOOLTIP', 'Deactivate notification rule?');
define('OVERVIEW_INACTIVE_TOOLTIP', 'Activate notification rule?');
...
define('ADD_EDIT_INCLUDE_CUSTOMVARIABLES', 'Include customvariables:');
define('ADD_EDIT_EXCLUDE_CUSTOMVARIABLES', 'Exclude customvariables:');
...
define('ADD_EDIT_NOTIFY_ON', 'Filter on:');
...
define('ADD_EDIT_NUM_NOTIFICATIONS', 'number of notifications (all types)');
...
define('LOG_VIEWER_HEADING_CUSTOMVARIABLE', 'Customvariable');
...
define('NOTIFY_UP', 'Host Up');
define('NOTIFY_UNREACHABLE', 'Host Unreachable');
define('NOTIFY_DOWN', 'Host Down');
define('NOTIFY_FLAPPING_START', 'Flapping started');
define('NOTIFY_FLAPPING_STOP', 'Flapping stopped');
define('NOTIFY_FLAPPING_DISABLED', 'Flap detection disabled');
define('NOTIFY_DOWNTIME_START', 'Downtime started');
define('NOTIFY_DOWNTIME_END', 'Downtime ended');
define('NOTIFY_DOWNTIME_CANCELLED', 'Downtime cancelled');
define('NOTIFY_ACKNOWLEDGEMENT', 'Acknowledgement');
define('NOTIFY_CUSTOM', 'Custom');
define('NOTIFY_ADVANCED', 'Problem transitions');
define('NOTIFY_WARNING_TO_CRITICAL', 'Warning to critical');
define('NOTIFY_WARNING_TO_UNKNOWN', 'Warning to unknown');
define('NOTIFY_CRITICAL_TO_WARNING', 'Critical to warning');
define('NOTIFY_CRITICAL_TO_UNKNOWN', 'Critical to unknown');
define('NOTIFY_UNKNOWN_TO_CRITICAL', 'Unknown to critical');
define('NOTIFY_UNKNOWN_TO_WARNING', 'Unknown to warning');
